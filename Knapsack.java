...
public class Knapsack {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter the weight and benefit of each item:");
        for (int i = 0; i < n; i++) {
        ...
        // Dynamic programming table to store maximum values
        ...
        // Determine the items selected for maximum value
        ...
        // Display the items selected for maximum value
